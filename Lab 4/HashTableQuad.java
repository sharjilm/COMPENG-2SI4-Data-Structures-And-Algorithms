...
public class HashTableQuad {
    ...
    // This constructor will create a HashTableQuad object representing an empty hash table with maximum
    ...
    // resolved using quadratic probing.
    public void insert(int n){
        ...
        if(( (numKeys) / ((double)table.length) ) >= maxLoad){
        ...
        if(table[index] == null){   // insert directly
            table[index] = n;
